...
for ii = 1:length(t)
    T(ii) = 1/2*constants.m*norm(vel(ii,:));
%     V(ii) = - constants.m*constants.mu / norm(constants.Re*[1;0;0] + constants.L*pos(ii,:)');
    V(ii) = - constants.m*constants.g*constants.Re^2 / norm(constants.Re*[1;0;0] + constants.L*pos(ii,:)');
%     V(ii) = -constants.m*constants.g*constants.L*pos(ii,1);
